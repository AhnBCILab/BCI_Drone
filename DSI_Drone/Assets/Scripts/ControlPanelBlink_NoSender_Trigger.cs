...
public class ControlPanelBlink_NoSender_Trigger : MonoBehaviour
{
    ...
    public void BlinkButton()
    {
        ...
        else
        {
            ...
            Move_with_ControlPanel_Trigger.outpNum = random;
            Move_with_ControlPanel_Trigger.ControlPanel_On_Off = 0;
