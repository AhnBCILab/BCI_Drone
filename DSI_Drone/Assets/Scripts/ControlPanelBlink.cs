...
public class ControlPanelBlink : MonoBehaviour
{
    ...
    public float timebetweenarrows = 0.130f;
    ...
    void OnEnable()
    {
        ...
        current_time = 0.0f;
        blinkcnt = 0;
        Button0 = true; Button1 = true; Button2 = true; Button3 = true; Button4 = true; Button5 = true;
        up = 0; left = 0; right = 0; bward = 0; down = 0; fward = 0;
        count = 0;
        buttonIndexNum = 0;
        rndnum = 0;
        outp = "";
    ...
    public void BlinkButton()
    {
        ...
        else
        {
            ...
            //Move_with_ControlPanel.outpNum = random;
            Move_with_ControlPanel.ControlPanel_On_Off = 0;
