...
public class ControlPanel_Blink_Seven_AR : MonoBehaviour
{
    ...
    public void BlinkButton()
    {
        ...
        else
        {
            ...
            writer.WriteLine("AR Result: " + output+" /order: "+ next_move);
            writer.Close();
            int result = 0;
            switch (output)
            {
            ...
            {
                Move_with_ControlPanel_Seven_AR.outpNum = 0;
            }
